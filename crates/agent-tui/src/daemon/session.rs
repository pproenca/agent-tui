...
use crate::terminal::key_to_escape_sequence;

use super::pty_session::PtySession;
use crate::daemon::terminal_state::TerminalState;

pub use crate::daemon::domain::session_types::ErrorEntry;
pub use crate::daemon::domain::session_types::RecordingFrame;
pub use crate::daemon::domain::session_types::RecordingStatus;
pub use crate::daemon::domain::session_types::SessionId;
pub use crate::daemon::domain::session_types::SessionInfo;
pub use crate::daemon::domain::session_types::TraceEntry;
pub use crate::daemon::error::SessionError;
...
impl Session {
    ...
    pub fn analyze_screen(&self) -> Vec<crate::core::Component> {
        let cursor = self.terminal.cursor();
        self.terminal.analyze_screen(&cursor)
    }
}

impl crate::daemon::repository::SessionOps for Session {
    ...
    fn analyze_screen(&self) -> Vec<crate::core::Component> {
