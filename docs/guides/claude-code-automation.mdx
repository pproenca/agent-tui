...
description: 'The killer feature: AI controlling AI'
---

## Overview

agent-tui can automate Claude Code itself — enabling an AI to control an AI's interface. This opens up powerful use cases:
